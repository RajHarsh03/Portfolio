...
export default function Contact() {
  ...
  async function submitForm() {
    ...
    try {
      ...
      setToast({
        msg: 'Failed to send. Please try emailing <a href="mailto:rajharsh.devx@gmail.com" style="color:inherit;text-decoration:underline">rajharsh.devx@gmail.com</a> directly.',
        type: 'toast-err',
      });
    } finally {
      setSending(false);
          ...
          <div className="contact-grid">
            ...
            <div>
              ...
              <div className="socials reveal">
                ...
                <a href="mailto:rajharsh.devx@gmail.com" className="social-link">
