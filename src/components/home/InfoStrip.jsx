  ...
  return (
    ...
    >
      ...
      <div className="np-art">
        {track?.artwork
          ? <>
              <img src={track.artwork} alt={track.title} className={isPlaying ? 'np-vinyl-spin' : ''} />
              {/* Tonearm */}
              <div className={`np-tonearm${isPlaying ? ' np-tonearm--playing' : ''}`}>
                <div className="np-tonearm-arm"></div>
                <div className="np-tonearm-head"></div>
              </div>
            </>
        ...
        {/* Pulse ring when playing - keep for additional effect */}
